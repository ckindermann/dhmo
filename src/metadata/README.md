 ...
 * [dhmo.yml](dhmo.yml)
     * Determines how your purl.obolibrary.org/obo/dhmo/ redirects will be handled
     ...
     * Paste in the contents of [dhmo.yml](dhmo.yml)
 ...
 * [dhmo.md](dhmo.md)
     ...
     * Paste in the contents of [dhmo.md](dhmo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
