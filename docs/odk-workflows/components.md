...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/dhmo-odk.yaml)
...
```
  <uri name="https://github.com/bmir-radx/rxow/dhmo/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/dhmo-edit.obo)
for .obo formats: 

```
import: https://github.com/bmir-radx/rxow/dhmo/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/dhmo.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
